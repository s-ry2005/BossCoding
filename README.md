...
合并不是终点。涉及部署或正式交付时，AI 会继续验证真实线上地址上的核心路径，再用 `neat-freak` 同步代码、运行状态、文档、规则、获准维护的记忆和工作区。最后会给出收尾报告；分支、工作区和临时资源只在你看完报告并明确确认后才清理。

本地工具不需要部署时，AI 会如实标记为“不适用”，但不会跳过知识收尾。完整裁决见 [线上验证与知识收尾](docs/decisions/2026-08-06-live-verification-and-closeout.md)。
...
| 三个 BossCoding 技能 | 教 AI 完成交付、渐进推进 GitHub/服务器/域名，并完成线上验证与知识收尾 |
